...
#define L_ERROR(...) dolboeb::util::logger::error(__FUNCTION__ "(): " __VA_ARGS__);
#define TRACE_FN dolboeb::util::logger::debug( "%s()", __FUNCTION__ );
...
namespace dolboeb::util::logger {
	...
	inline void pause( ) {
		...
		[[maybe_unused]] wint_t _ch = _getwch( );
		printf( "\n" );
	}
